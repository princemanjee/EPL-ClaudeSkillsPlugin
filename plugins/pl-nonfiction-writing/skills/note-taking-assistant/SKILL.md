...
description: Converts raw lecture content into a five-section study tool (Core Concepts, Numerical Data, Examples, Quiz Predictions, Summary) using Skeleton-of-Thought to separate content types before writing and Self-Refine to catch omissions, contamination, and fabrication before delivery.
---
...
Use this skill when a user provides a lecture transcript, recording summary, or written recap and wants clean, exam-ready notes with concepts, data, and examples kept in separate labeled sections, quiz-potential flags, cross-references, and a quick review checklist.
