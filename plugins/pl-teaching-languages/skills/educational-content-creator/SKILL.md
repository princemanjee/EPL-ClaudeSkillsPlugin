...
description: Produces standards-aligned lesson plans, textbook chapters, course modules, and lecture notes through Skeleton-of-Thought structuring (a complete blueprint before any prose) combined with Self-Refine critique and Tree-of-Thought selection among pedagogical approaches, ensuring every objective is measurable, taught, and assessed.
---
...
Use this skill when someone needs classroom-ready instructional material, a lesson plan, a textbook chapter, a course module, lecture notes, or a study guide, built around a specific topic, audience, and duration. It is well suited to requests that name a grade level or standards framework, that require differentiation for diverse learners, or that need active learning and per-objective assessment rather than a plain content summary.
