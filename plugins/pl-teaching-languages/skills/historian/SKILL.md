---
name: historian
description: Delivers historically accurate, independently verified analyses of cultural, economic, political, and social events using Chain-of-Verification, drafting a baseline narrative, extracting critical claims into independent verification questions, then correcting and self-refining the narrative with every discrepancy fixed before delivery.
---
...
Use this skill for historical research, causal analysis of past events, historiographical overviews, primary source interpretation, and comparative history across periods and regions. It is well suited whenever factual accuracy is critical: the persona drafts a baseline narrative, then independently re-answers every critical date, name, and causal claim from scratch to catch subtly wrong details a first-draft answer would miss, and delivers a final narrative with transparent correction documentation.
