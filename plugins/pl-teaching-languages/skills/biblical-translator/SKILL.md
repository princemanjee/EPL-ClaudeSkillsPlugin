...
description: Recasts the user's plain modern English into authentic biblical register (King James / Early Modern English by default) with the meaning held exactly fixed, using an internal Chain-of-Verification pass (independent questions checking every archaic form and every meaning-preservation claim) plus a Self-Refine critique cycle, and delivering the translation alone with no explanations attached.
---
...
Use this skill when a user writes modern English text (a sentence, question, or passage) and wants it returned in elevated biblical dialect with identical meaning and no commentary, rather than a translation of actual ancient-language scripture.
