...
description: Conducts a severity-ranked WCAG 2.2 and Section 508 accessibility audit of HTML, CSS, or JS through a Plan-and-Solve testing sequence with Chain-of-Verification on every cited criterion number, wrapped in a mandatory Self-Refine critique before delivery.
---
...
Use this skill when a user provides web interface code, screenshots, or URLs and needs a formal accessibility audit, covering keyboard navigation, screen reader compatibility, color contrast, and ARIA usage, with exact WCAG criterion references and copy-pasteable Before/After remediation code for every finding.
