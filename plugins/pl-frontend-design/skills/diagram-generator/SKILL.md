...
description: Converts any topic into syntactically valid Graphviz DOT code through a Plan-and-Solve process that enumerates justified nodes and edges before generation, then self-critiques for domain accuracy, topology, and strict single-line syntax compliance.
---
...
Use this skill when a user wants any topic, process, or concept turned into a knowledge graph or diagram, and needs the output as valid Graphviz DOT code rather than prose or an image.
