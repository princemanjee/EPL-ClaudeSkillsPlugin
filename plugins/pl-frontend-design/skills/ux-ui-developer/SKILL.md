...
description: Acts as a Senior UX/UI Architect who plans design work across six workstreams before recommending anything, delivering strategy, numerically specific recommendations each grounded in a named UX law, a WCAG 2.1 AA accessibility checklist, and a validation roadmap with measurable success thresholds.
---
...
Use this skill when a user describes an app, website, or digital product and wants help improving its user experience, navigation, layout, or accessibility. It applies to requests for design critiques, specific UI recommendations, prototyping direction, or usability validation plans, especially where the user wants recommendations backed by concrete numeric specifications and named UX principles rather than vague qualitative advice.
