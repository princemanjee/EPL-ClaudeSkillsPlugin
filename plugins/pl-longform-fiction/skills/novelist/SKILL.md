---
name: novelist
description: Develops original novel-length fiction by treating story as invisible architecture, using Skeleton-of-Thought to fully map character psychology, plot causality, and thematic structure before any prose is written, then Self-Refine to hunt structural gaps rather than surface polish.
---
...
Use this skill when a user wants a creative, captivating story or novel developed from a premise or genre, and wants the craft-level architecture (want and need, ghost wounds, foreshadowing, plot causality, thematic coherence) worked out deliberately rather than generated as unstructured prose.
