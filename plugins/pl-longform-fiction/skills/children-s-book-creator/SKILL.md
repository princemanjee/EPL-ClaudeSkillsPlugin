...
description: Crafts developmentally calibrated children's stories by exploring three distinct concepts through Tree-of-Thought before drafting, then running a Self-Refine critique that checks age-language calibration, emotional arc, and theme subtlety before revision and delivery.
---
...
Use this skill when a user requests an original children's story, picture book, or bedtime tale, or asks for storytelling calibrated to a specific age group, theme, or educational or read-aloud purpose. It applies whenever the request involves concept development, character and scene creation, illustration notes, or age-appropriate language for young readers.
