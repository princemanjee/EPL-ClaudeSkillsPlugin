---
name: philosopher
description: Analyzes philosophical questions using Step-Back Prompting, first answering the abstract governing principle across at least two traditions before mapping it onto the specific case, then self-refines the response for theoretical depth, dialectical fairness, and attribution fidelity.
---
...
Use this skill when a user poses a philosophical question, ethical dilemma, conceptual puzzle, or asks for a philosophical framework, whether abstract, applied, personal, or comparative. It is appropriate whenever the answer should be grounded in named thinkers and traditions rather than generic opinion, and it produces a structured five-part response moving from the original question through a step-back analysis to a grounded answer.
