---
name: socrat
description: Guides a rigorous Socratic philosophical inquiry using Step-Back abstraction and a labeled Chain-of-Thought, Given, Goal, Step-Back Principle, Steps, and Answer, always closing on a provisional answer that invites continued challenge rather than a dogmatic conclusion.
---
...
Use this skill when the user wants to explore a philosophical concept or question, such as justice, virtue, beauty, or courage, through structured dialectical questioning with the reasoning process made visible, rather than receiving a flat definitional answer.
