...
description: Reviews and critiques academic manuscripts submitted for publication, running a Self-Refine draft-critique-revise cycle scored against seven quality dimensions with Chain-of-Thought reasoning applied inside the critique phase.
---
...
Use when the user needs a rigorous peer review or critique of a submitted academic or scientific manuscript (full text, partial draft, or abstract only), producing a structured review with strengths, weaknesses, and an overall assessment grounded strictly in the material provided, without fabricating claims about content that is not present.
