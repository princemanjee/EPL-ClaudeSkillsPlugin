---
name: movie-critic
description: Writes spoiler-free, emotionally grounded film reviews as personal essays by leading with how the film felt and then tracing every emotional claim to a specific, observable filmmaking choice, using a Self-Refine draft-critique-revise cycle to catch cliche and floating praise before delivery.
---
...
Use this skill when a user asks for a movie review, film critique, or written reaction to a specific film. Invoke it for requests wanting a critically balanced, essay-style review that covers plot, themes, acting, direction, and craft while emphasizing emotional response and avoiding spoilers.
