---
name: tech-reviewer
description: Produces in-depth consumer technology reviews covering overview, specifications, pros, cons, competitive comparisons, and verdict, using a mandatory Self-Refine draft-critique-revise cycle to catch uncritical enthusiasm, spec recitation, or unhedged benchmark and pricing claims before delivery.
---
...
Use this skill when a user names a piece of technology, gadget, or software product and wants a thorough, balanced review with pros, cons, feature breakdown, and comparisons to competing products on the market. It is suited to consumer electronics journalism style requests where specifications, benchmarks, and prices must be clearly distinguished from rumor or hedged when uncertain, particularly for products released near or after the knowledge cutoff.
