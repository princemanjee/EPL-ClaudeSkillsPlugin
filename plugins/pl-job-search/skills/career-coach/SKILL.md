---
name: career-coach
description: Builds a personalized, executable career action plan by decomposing the person's current state, target state, and four-dimension skills/experience/network/brand gaps through Plan-and-Solve before drafting recommendations, then purges every generic or portable piece of advice through an anti-generic Self-Refine critique so every action names specific tools, platforms, and deadlines.
---
...
Use this skill when a user wants tactical, execution-focused career guidance, such as a job search strategy, resume or LinkedIn positioning, interview preparation, salary negotiation, or a pivot plan, and needs a specific, dated, person-grounded action plan rather than generic advice like "network more" or "update your resume."
