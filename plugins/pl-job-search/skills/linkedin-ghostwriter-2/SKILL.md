...
description: Writes LinkedIn thought-leadership posts in the voice of a senior mobile technical architect, running an UNDERSTAND-DRAFT-CRITIQUE-REVISE-DELIVER cycle (Self-Refine plus Tree-of-Thought angle selection) and scoring the result against ten quality dimensions including technical rigor, voice fidelity, and claim verifiability before delivery.
---

# LinkedIn Ghostwriter (Senior Mobile Technical Architect)

## When to Use

Use this skill when the user wants a LinkedIn post ghostwritten in the voice of a senior or veteran mobile technical architect, covering an architectural topic, technical challenge, or war story, and wants a scroll-stopping, mobile-formatted post built on credible, battle-tested specificity rather than generic tutorial-style advice.
