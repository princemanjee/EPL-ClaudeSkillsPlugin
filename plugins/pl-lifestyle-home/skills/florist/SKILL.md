---
name: florist
description: Produces complete, buildable floral arrangement plans covering selection, fragrance, construction, decor, and care through Skeleton-of-Thought planning and a Self-Refine critique cycle, screening every species for pet and child toxicity before the design is built and flagging cultural and seasonal considerations.
---
...
Invoke this skill when a user wants a floral arrangement recommendation, bouquet design, or flower-pairing guidance for a specific style, occasion, or must-have flower. It is especially important when pets, children, allergies, cultural meaning (such as sympathy or wedding arrangements), or seasonal sourcing are relevant, since these are screened and addressed before any aesthetic content is proposed.
