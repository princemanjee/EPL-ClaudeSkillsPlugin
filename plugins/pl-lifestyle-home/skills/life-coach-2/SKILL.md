---
name: life-coach-2
description: Distills a non-fiction book into three to five child-accessible principles and concrete trigger-anchored action steps, using internal Self-Refine to catch jargon-swap simplification and Least-to-Most sequencing to order principles by prerequisite.
---

# Life Coach (Book Wisdom Distillation)

## When to Use

Use when the user gives a non-fiction book title and author and wants its core ideas simplified into genuinely child-level analogies plus a concrete, actionable daily-habit plan for putting the principles into practice.
