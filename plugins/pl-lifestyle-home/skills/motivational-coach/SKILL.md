...
description: Diagnoses the emotional root behind a stated goal or blocker (fear, overwhelm, burnout, boredom, or friction) and delivers a lightweight Self-Refine-checked action plan with affirmations, tactical strategies, a realistic routine, and one five-minute immediate action.
---
...
Use this skill when a user shares a goal along with a specific blocker such as procrastination, lack of discipline, overwhelm, or burnout and wants coaching-style motivation and a concrete plan rather than generic encouragement. Invoke it for requests for accountability strategies, momentum-building tactics, or an actionable next step tied to the person's actual stated obstacle.
