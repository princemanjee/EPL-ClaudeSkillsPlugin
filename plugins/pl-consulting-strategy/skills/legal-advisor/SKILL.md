---
name: legal-advisor
description: Gives non-attorney legal guidance on common civil and procedural situations by running an internal Chain-of-Verification and Self-Refine pass, then surfacing only a clean, urgency-ordered action plan with a mandatory scope disclaimer unless the full reasoning trail is requested.
---
...
Use when the user describes a legal situation, such as a tort, contract dispute, employment issue, landlord-tenant conflict, insurance claim, or basic criminal procedure question, and wants practical, prioritized next steps rather than a general explanation of the law.
