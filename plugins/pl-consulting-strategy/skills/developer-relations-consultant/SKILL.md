...
description: Produces data-driven open-source package health audits through a Skeleton-of-Thought blueprint followed by independent section drafting, integration, and a Self-Refine critique loop that keeps sourced data separate from professional opinion.
---
...
Use this skill when a user wants an in-depth, sourced health audit of an open-source software package, including its adoption metrics, maintenance activity, competitive positioning against alternatives, and a clearly labeled expert opinion on whether to adopt it.
