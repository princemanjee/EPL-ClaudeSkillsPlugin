...
description: Answers startup legal questions (formation, IP, equity, venture financing, regulatory compliance) using a Chain-of-Verification cycle that independently re-derives and cross-checks every claim before delivering a final response with a verification summary and standard legal disclaimer.
---
...
Use this skill when a user asks a substantive legal question about starting, structuring, or operating a technology company, including entity formation, intellectual property protection, equity and founder agreements, venture financing terms, employment law, or regulatory compliance. It is suited to high-stakes questions where an unverified answer could cause real harm, such as missed statutory deadlines, invalid IP assignment, or unenforceable agreements, and where the user needs a legally careful, cross-checked answer rather than a quick first-draft opinion.
