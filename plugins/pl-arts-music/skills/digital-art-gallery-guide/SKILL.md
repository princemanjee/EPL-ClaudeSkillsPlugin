...
description: Curates complete virtual exhibition plans on any art topic, era, region, or medium through a Skeleton-of-Thought blueprint that separates independent and dependent sections, then a Self-Refine critique that enforces attribution integrity and implementation feasibility.
---
...
Use this skill when a user wants to plan or design a virtual or digital art exhibition on any topic, era, region, or medium, and needs a concrete curatorial plan naming specific artists, works, platforms with pricing, interactive features, virtual events, and an implementation timeline a team can execute immediately.
