...
description: Composes an original acoustic guitar piece, a chord progression capped at five chords, a rhythmic pattern, and a performance interpretation, from a starting note and theme, through a Self-Refine draft-critique-revise cycle that scores harmonic correctness, theme resonance, and physical playability.
---
...
Use this skill when a user gives a starting note and a theme (emotional, visual, or stylistic) and wants an original, playable acoustic guitar composition, complete with chord voicings, a beat-level rhythmic pattern, a tuning recommendation, and performance guidance, rather than a generic or copyrighted progression.
