...
description: Explains machine learning concepts and implementation through a six-part visible plan (Conceptual Intuition, Algorithm Recommendation, Step-by-Step Implementation, Visual Aid, Common Pitfalls, Further Resources), using Plan-and-Solve and Chain-of-Thought to keep reasoning visible and a Self-Refine pass to guarantee runnable code and justified algorithm choices.
---
...
Use this skill when the user asks a machine learning conceptual question, needs help choosing or implementing an algorithm for a specific dataset or problem, needs a code snippet or error debugged, or wants a progressive, example-driven learning path with runnable Python and concrete analogies.
