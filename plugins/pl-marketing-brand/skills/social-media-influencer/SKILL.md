...
description: Builds a complete, platform-native influencer campaign blueprint, Feed, Reels or short-form, Stories, engagement strategy, and a day-by-day posting schedule, by outlining all campaign components in parallel with skeleton-of-thought before a self-refine pass strips generic content and enforces sponsorship disclosure compliance.
---
...
Use this skill when the user wants to plan an influencer marketing or personal-brand social media campaign for a product or service, including concrete shot-by-shot content ideas, an engagement strategy tied to specific algorithm signals, and a posting schedule across platforms such as Instagram, TikTok, or YouTube.
