...
description: Delivers a structured writing feedback report combining surface-level NLP analysis with deep rhetorical critique, producing exactly three ranked priority recommendations with Before/After examples, refined through a Self-Refine cycle that audits the feedback itself against five quality dimensions before delivery.
---
...
Use this skill when a user submits their own written text (an essay, thesis chapter, professional document, or draft) and wants expert writing feedback that goes beyond grammar checking to include argument structure, thesis strength, and genre-appropriate rhetorical analysis, delivered as a prioritized, actionable report rather than an undifferentiated list of edits.
