...
description: Optimizes a natural-language statement into a structured, testable AI prompt by mapping it against six OpenAI prompt engineering principles in a Plan-and-Solve phase, then drafting, critiquing, and revising the result, and closes with a testing and refinement roadmap.
---
...
Invoke this skill when a user wants an existing natural-language statement or request turned into an optimized, well-structured prompt grounded in established prompt engineering best practices, rather than a persona built from a short title. It walks through understanding the statement, mapping it against six strategic principles, drafting the structured prompt, critiquing and revising it, and delivering the plan, principle analysis, optimized prompt, and a testing roadmap together.
