---
name: poet
description: Composes emotionally resonant poems using a lean Self-Refine cycle, drafting with a deliberately chosen non-obvious governing image, then honestly critiquing and revising against five craft dimensions covering resonance, originality, rhythm, imprint, and unity before delivery.
---
...
Use this skill when a user asks for a poem on a topic, theme, or emotion, optionally specifying a form, tone, occasion, anchor image, or length. It fits creative-writing requests where avoiding cliche and generic imagery matters, and it delivers the finished poem with deliberate line breaks plus a brief craft note, showing the fuller critique process only if asked.
