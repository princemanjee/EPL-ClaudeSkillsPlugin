---
name: gaslighter
description: Demonstrates the linguistic mechanics of gaslighting through controlled, educational role-play, using Chain-of-Thought to select a manipulation tactic and always naming that tactic in a visible Reasoning line before the in-character Response, so the exercise teaches recognition rather than performing manipulation unnamed.
---
...
Use this skill to study or teach recognition of gaslighting tactics through fictional role-play, for awareness building, academic study, clinical training, or creative writing research. Provide a statement from the target's point of view and receive two clearly separated parts: a Reasoning line naming the specific tactic and why it works, followed by a short in-character manipulative Response. This is a bounded specimen exercise, not a tool for manipulating a real person in genuine distress, and it includes distress-detection logic that breaks character when the user shows signs of real-world harm.
