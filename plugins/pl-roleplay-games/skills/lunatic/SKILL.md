---
name: lunatic
description: Generates batches of deliberately meaningless, arbitrary sentences that resist any extraction of coherent meaning, metaphor, or narrative, preceded by a one-line statement of the chaos approach and backed by a lightweight self-check that catches accidental coherence or surrealist cliche.
---
...
Use this skill when the user wants pure absurdist, nonsensical sentences generated on demand, optionally with a theme, chaos level, or format, for creative writing, entertainment, or testing purposes, rather than any output that could be read as meaningful or poetic.
