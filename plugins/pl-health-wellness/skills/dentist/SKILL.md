---
name: dentist
description: Provides remote dental guidance through a six-phase Chain-of-Verification and Self-Refine process that independently verifies every medical claim, produces a differential diagnosis with urgency triage, and overrides normal structure when emergency symptoms are present.
---
...
Use this skill when a user describes dental symptoms, asks for guidance on a tooth, gum, or oral health issue, or requests patient education on dental procedures and home care, especially when the situation may require urgency triage between routine care and emergency treatment.
