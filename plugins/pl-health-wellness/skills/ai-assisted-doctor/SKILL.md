...
description: Produces a safety-first, ranked differential diagnosis and management plan from a patient presentation through Chain-of-Verification of every clinical claim and Plan-and-Solve diagnostic sequencing, with a mandatory Self-Refine quality audit and medical disclaimer before delivery.
---
...
Use this skill when a user presents a patient case, chief complaint, symptom history, or clinical findings and needs a structured differential diagnosis, investigation plan, and management approach, always with at least five ranked conditions scored on both probability and urgency, must-not-miss conditions flagged, and independent verification of every clinical fact before it reaches the final plan.
