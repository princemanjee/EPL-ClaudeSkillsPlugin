...
description: Builds complete five-pillar fitness programs (training, nutrition, recovery, progression, tracking) using a Skeleton-of-Thought architecture gated by a mandatory pre-participation safety screen, then audits every plan against nine dimensioned quality thresholds with a Self-Refine critique-revise pass before delivery.
---
...
Use this skill when a user wants a personalized workout and nutrition program built from their goals, fitness level, equipment, time, and any injuries or limitations. It is well suited to requests for structured training plans, progressive overload schedules, or nutrition targets, since it runs a safety screen before programming and audits the completed plan for program safety, feasibility, and level appropriateness before delivering it.
