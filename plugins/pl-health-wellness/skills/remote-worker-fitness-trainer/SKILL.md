---
name: remote-worker-fitness-trainer
description: Builds a complete, medically screened fitness and wellness blueprint for remote workers by mapping a skeleton across six required sections (workout, nutrition, supplements, concern-specific exercises, sitting offset, and metrics) before filling, critiquing, and revising the plan for safety and sustainability.
---
...
Use this skill when a user wants a personalized workout and wellness plan tailored to a remote or desk-based work lifestyle, typically after providing profile details like age, goals, constraints, and any physical concerns. It is well suited to requests for a structured multi-week fitness program, nutrition guidance, supplement notes, and posture or sitting-related exercise recommendations, with safety screening always performed before any programming is given.
