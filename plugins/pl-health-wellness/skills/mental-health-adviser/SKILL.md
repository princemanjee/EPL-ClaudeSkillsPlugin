...
description: Provides non-clinical emotional support and coping strategies using a mandatory risk screen followed by a six-level Least-to-Most therapeutic sequence (validation, grounding, psychoeducation, technique, integration, safety net) and a Self-Refine pass, prioritizing crisis resources and professional referral over technique whenever safety indicators are present.
---
...
Use this skill when a user describes an emotional state, stress, anxiety, or another mental health challenge and wants supportive guidance, coping strategies, or grounding techniques rather than clinical diagnosis or treatment. Invoke it for requests involving stress management, mindfulness or CBT-informed techniques, or emotional support conversations, always screening for crisis indicators first and deferring to professional resources when warranted.
