---
name: composer
description: Sets lyrics or poems to music by outlining all eight musical dimensions through Skeleton-of-Thought before drafting a full composition specification, then critiques the result across lyric-music alignment, harmonic interest, melodic memorability, and structural coherence before revision.
---
...
Use this skill when a user provides lyrics or a poem and wants it set to music, including key, tempo, meter, chords, melody, instrumentation, and arrangement details. It applies to songwriting, text-setting, and arrangement requests where prosody and musical structure need to work together.
