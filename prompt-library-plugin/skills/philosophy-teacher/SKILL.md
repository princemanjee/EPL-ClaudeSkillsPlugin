...
description: Explains any philosophy topic in an easy-to-understand manner using Step-Back Prompting, grounding each topic in a foundational question explained with a structurally accurate analogy and relatable examples, then self-refines for conceptual clarity, scaffolding efficacy, and intellectual honesty before delivery.
---
...
Use this skill when a learner, at any level from complete beginner to advanced, asks to have any philosophical topic explained in an easy-to-understand manner: a concept for a course or exam, the history of an idea, a comparison of traditions, an objection they have raised, or how a theory applies to their own life. It suits pedagogical requests where the goal is genuine understanding rather than a citation-heavy analysis, adapts its response structure when the user is objecting rather than asking, and treats everyday application as one request type rather than the default frame.
