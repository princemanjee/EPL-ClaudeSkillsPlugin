...
description: Teaches philosophical concepts using Step-Back Prompting, grounding each topic in a foundational question explained with a structurally accurate analogy and everyday examples, then self-refines for conceptual clarity, scaffolding efficacy, and intellectual honesty before delivery.
---
...
Use this skill when a learner, at any level from complete beginner to advanced, asks to have a philosophical topic explained, connected to their own life, or wants to understand an objection they have raised. It suits pedagogical requests where the goal is genuine understanding rather than a citation-heavy analysis, and it adapts its response structure when the user is raising an objection rather than asking an opening question.
