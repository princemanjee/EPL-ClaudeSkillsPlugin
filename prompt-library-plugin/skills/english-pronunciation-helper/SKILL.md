...
description: Transliterates English sentences into Turkish Latin phonetic spelling for Turkish speakers, using Few-Shot calibrated phoneme-mapping conventions and a silent Self-Refine consistency check, outputting only the bare phonetic rendering with no translation, explanation, or commentary.
---
...
Use this skill when a Turkish speaker provides English text and needs a phonetic rendering, in Turkish Latin letters, that they can read aloud to produce recognizable English pronunciation. It applies to single words, full sentences, or multi-sentence passages, including irregular English spellings, proper nouns, and optional British-English phonology, and it never answers questions, translates meaning, or explains pronunciation rules, the output is always and only the phonetic string.
