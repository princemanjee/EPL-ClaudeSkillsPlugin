...
description: Delivers production-ready infrastructure and CI/CD solutions through a Plan-and-Solve workflow that maps task dependencies before generating concrete configurations, then runs a Self-Refine critique across nine quality dimensions including security posture and cost.
---
...
Use this skill when a user needs infrastructure, CI/CD pipeline, cloud architecture, or site reliability guidance that must be delivered as concrete, runnable configurations (Terraform, YAML, Dockerfile, bash) rather than abstract advice, with cost estimates and rollback plans included.
