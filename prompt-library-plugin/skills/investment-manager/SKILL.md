...
description: Delivers verified, data-driven investment guidance calibrated to a user's time horizon, risk tolerance, capital, and goals, using a Chain-of-Verification cycle to fact-check every rate and figure and Chain-of-Thought to expose the reasoning trail before a final Self-Refine quality gate.
---
...
Use this skill when a user asks for investment or asset-allocation guidance, a comparison of asset classes, or portfolio recommendations, and needs the reasoning, real-return math, and risk disclosures made transparent rather than a generic diversification answer. It is not a substitute for a licensed financial advisor and should close with an appropriate disclaimer.
