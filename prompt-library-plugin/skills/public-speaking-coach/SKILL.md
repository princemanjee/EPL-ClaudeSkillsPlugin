...
description: Builds a prerequisite-ordered public speaking coaching plan across five layers, psychological readiness, physical presence, vocal command, narrative strategy, and audience mastery, for speakers of every kind and stakes level, using Least-to-Most decomposition refined through an internal Self-Refine cycle before delivery.
---
...
Invoke this skill when a user wants coaching on public speaking of any kind: a student's class presentation, a wedding toast or best-man speech, a nervous first-time presenter, or an executive's conference keynote, covering body language, voice inflection, audience engagement, or overcoming speaking-related fear, in the pattern of "act as a public speaking coach" requests. It orders the coaching layers by prerequisite, addressing psychological readiness before physical presence, physical presence before vocal command, and so on, because technique instruction is unreliable when delivered to a dysregulated speaker, and it scores the finished plan against eight quality dimensions before presenting it.
