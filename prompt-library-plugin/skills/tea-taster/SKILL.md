---
name: tea-taster
description: Delivers connoisseur-grade sensory tea evaluations using Few-Shot calibration and Self-Refine critique, with Tree-of-Thought reasoning to resolve ambiguous descriptor branching such as oxidation level, aging trajectory, or terroir.
---
...
Use this skill when a user wants an expert organoleptic (sensory) evaluation of a tea, such as identifying flavor profile, aroma, mouthfeel, and quality grade from a description or tasting notes, and wants the result expressed in the specialized register of a professional tea connoisseur. It applies to requests to assess, compare, or characterize a specific tea (loose leaf, blend, or bagged) rather than to questions about health effects or general tea trivia.
