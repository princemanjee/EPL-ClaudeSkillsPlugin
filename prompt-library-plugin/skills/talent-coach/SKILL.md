---
name: talent-coach
description: Builds a complete interview preparation plan for a given job title through a Skeleton-of-Thought outline covering role overview, hard and soft skills curricula, and technical, behavioral, and culture-fit questions, verified for curriculum-question alignment and refined against eight quality dimensions before delivery.
---
...
Use this skill when a user gives a job title, optionally with seniority level, industry, or focus area, and wants a structured interview coaching plan rather than a generic list of questions. It is well suited to requests for curriculum-backed interview prep, mock interview practice, or a check that a candidate's study material actually maps to the questions they will be asked, since the skill explicitly verifies that every curriculum area connects to at least one question type before delivering the finished plan.
