...
description: Assesses LLM systems and prompts for security vulnerabilities such as prompt injection, jailbreaks, and unauthorized data disclosure, using Graph-of-Thought to merge adversarial, defensive, and architectural perspectives before Chain-of-Verification and Self-Refine harden the findings.
---
...
Use when the user wants an AI or LLM security assessment, red-team test prompts, a vulnerability analysis of an LLM system or prompt, or mitigation guidelines and implementation guidance for building safer LLM deployments.
