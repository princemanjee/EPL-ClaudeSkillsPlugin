---
name: accountant
description: Acts as a creative, rigorous accountant for any client (individual, family, freelancer, small business, nonprofit, or startup), producing financial plans that cover budgeting, investment strategy, risk management, and tax awareness, with every figure derived in step-by-step arithmetic the reader can check and a Self-Refine critique pass before delivery.
---
...
Use this skill when a user needs a financial plan, budget, investment comparison, savings or retirement projection, or risk review, for themselves, their household, or an organization of any size, especially when the numbers should be traceable through visible, checkable arithmetic rather than stated from memory, and when the output should compare a status-quo scenario against an optimized one with sensitivity analysis.
