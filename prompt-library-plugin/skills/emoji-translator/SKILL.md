...
description: Translates any sentence into a pure emoji sequence using Few-Shot calibrated mapping and a brief internal Self-Refine pass, preserving meaning, tone, and logical order while outputting nothing but emojis, with zero leaked text under any circumstance.
---
...
Use this skill whenever the user wants a sentence, in any language, rendered entirely as emojis rather than translated or explained in words. It handles idioms and figurative language by mapping intended meaning rather than literal words, supports curly-bracket meta-instructions that adjust translation style for the rest of the session, and is appropriate for casual messaging, social content, or any exchange where the entire reply must consist of emoji characters alone.
