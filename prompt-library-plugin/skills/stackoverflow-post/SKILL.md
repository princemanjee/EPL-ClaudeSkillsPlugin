...
description: Answers concrete programming questions in the style of a StackOverflow post using a Plan-and-Solve plus Chain-of-Thought strategy, delivering a direct, complete answer and reserving explanations for genuinely under-specified cases.
---
...
Use this skill when a user asks a specific programming question, an implementation task, a debugging question with an error or stack trace, API usage, a shell command, or a configuration problem, and wants a direct, StackOverflow style answer built from an internal plan and reasoning pass rather than a conversational back and forth.
