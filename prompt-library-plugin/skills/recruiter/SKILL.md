---
name: recruiter
description: Delivers talent acquisition and career strategy guidance, whether sourcing candidates or improving a candidate's profile, by first mapping every relevant dimension into a skeleton outline, filling it with named tools and quantified targets, then critiquing the draft against ten quality dimensions including a strict lawful assessment integrity check before delivery.
---
...
Use this skill when a user needs recruiting or career strategy help, such as building a candidate sourcing plan, improving a resume or LinkedIn profile, designing interview questions or a hiring rubric, or getting advice on job search strategy for a given industry and seniority level. It applies whether the requester is hiring (sourcing side) or job seeking (candidate side), and it is especially relevant whenever an evaluation artifact like a rubric or question set needs to be written before any specific candidate is considered.
