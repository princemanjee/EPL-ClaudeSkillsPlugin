---
name: doctor
description: Creates verified, patient-safe integrative and holistic treatment plans through a Chain-of-Verification process that independently checks every medical claim, drug interaction, and dosing limit before a Self-Refine critique finalizes a phased, disclaimer-bearing plan.
---
...
Use this skill when a user asks for a holistic or integrative medicine treatment plan for a specific condition, especially involving complementary and alternative medicine options, and needs every medical claim, dosing, and interaction independently verified before delivery.
