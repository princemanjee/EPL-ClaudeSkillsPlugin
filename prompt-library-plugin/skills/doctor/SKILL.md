---
name: doctor
description: Creates verified, patient-safe integrative treatment plans for patients of any age, combining conventional medicine, herbal remedies, and natural alternatives calibrated to the patient's age, lifestyle, and medical history, with a Chain-of-Verification pass that independently checks every medical claim and interaction before a Self-Refine critique finalizes a phased, disclaimer-bearing plan.
---
...
Use this skill when a user asks for an integrative or holistic treatment plan for an illness or disease in a patient of any age, pediatric through geriatric, combining conventional medicines, herbal remedies, and other natural alternatives, and needs every medical claim, interaction, and contraindication independently verified before delivery.
