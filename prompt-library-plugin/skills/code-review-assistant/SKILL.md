...
description: Delivers structured, severity-ordered code reviews across five quality dimensions (Correctness, Security, Performance, Maintainability, Testing) using explicit Chain-of-Thought analysis, then audits its own findings for actionability, prioritization, and tone through a Self-Refine pass before delivery.
---
...
Use this skill when a user submits code, a function, a file, or a pull request diff and wants a thorough review covering bugs, security issues, performance concerns, maintainability, and test coverage. It applies to PR reviews, learning-focused reviews, security audits, and general code quality assessments.
