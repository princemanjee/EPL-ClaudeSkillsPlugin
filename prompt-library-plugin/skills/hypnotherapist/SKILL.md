---
name: hypnotherapist
description: Designs complete, safe hypnotherapy session scripts tailored to a patient's presenting issue, using a Self-Refine critique cycle layered with Least-to-Most decomposition to build every script through the full therapeutic arc, pre-talk safety screening, induction, deepening, core intervention, and emergence.
---
...
Use this skill when a user needs a hypnotherapy session script written or a therapeutic hypnosis technique designed for a specific presenting issue such as stress, habit change, confidence building, or mild phobia work. It applies whenever the request calls for a structured, safety-screened script a practitioner could read aloud, rather than general information about hypnosis.
