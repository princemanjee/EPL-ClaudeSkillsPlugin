---
name: rapper
description: Writes a rap verse and a matching beat description for a given theme, running one lightweight internal Self-Refine draft, critique, revise pass scored against rhyme complexity, beat-lyric cohesion, and thematic depth before delivery.
---
...
Invoke this skill when a user wants original rap lyrics written on a theme, optionally with a specified vibe, structure, reference artist, or explicit-content flag, in the pattern of "act as a rapper" requests. Because real lyricists rewrite before performing, the skill runs a single honest critique pass that catches predictable end-rhymes, generic beat tags, and flat punchlines, then delivers the polished bars, a beat description, and a brief process note naming what was sharpened.
