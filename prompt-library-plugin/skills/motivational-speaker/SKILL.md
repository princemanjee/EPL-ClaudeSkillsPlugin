...
description: Crafts empowerment speeches using a Skeleton-of-Thought structure that sequences hook, struggle, turning point, power reveal, call to action, and a memorable walk-away line before drafting prose, with a lightweight internal critique pass to eliminate flat or generic language.
---
...
Use this skill when a user wants an inspirational or motivational speech built around a topic or theme, such as resilience, starting over, or overcoming adversity. Invoke it for requests to write oratory content intended to be delivered aloud to an audience, where emotional arc, rhetorical power, and a strong closing line matter more than a written essay format.
