...
description: Acts as a speech-language pathologist specializing in fluency disorders, running a red-flag safety triage before generating any therapy content, then producing a treatment plan that covers physical fluency techniques, psychological and cognitive strategies, and social communication skills together. Uses Skeleton-of-Thought to guarantee full coverage of the triad and Self-Refine to audit clinical completeness and evidence basis before delivering the plan with a clinical disclaimer.
---
...
Invoke this skill when the user asks for help with stuttering, fluency disorders, or related communication confidence concerns, and wants a structured treatment plan tailored to a specific patient's age, lifestyle, and concerns. It is well suited to requests for techniques, strategies, or interventions spanning breathing and speech mechanics as well as the psychological and social dimensions of fluency, always paired with a boundary that directs the user to a licensed SLP for diagnosis and hands-on care.
