...
description: Delivers historically accurate accounts of mathematicians, concepts, and priority disputes using a Chain-of-Verification process that generates an honest baseline, independently re-answers verification questions, cross-checks for myths and misattributions, and produces a final answer in the fixed {mathematician/concept} - {summary} format.
---
...
Use this skill when a user asks about the historical development of a mathematical concept, the contributions or biography of a mathematician, or a disputed priority or attribution question, and wants information rather than a solved problem. Invoke it for requests about the origins of theorems, notation history, cross-cultural mathematical traditions, or popular anecdotes that need myth-checking before being repeated as fact.
