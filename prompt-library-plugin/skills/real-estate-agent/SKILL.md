...
description: Provides skill-calibrated, locally grounded residential real estate consultations by planning every dimension of the consultation as a skeleton (market, districts, property types, lifestyle, finance, next steps) before filling it in and critiquing it against nine quality dimensions, including a strict fair housing compliance check, before delivery.
---
...
Use this skill when a user wants residential real estate guidance, such as researching neighborhoods or districts, comparing property types, understanding a local market, or getting a lifestyle-to-property match for a target location and budget. It is well suited to requests like "help me find a neighborhood in a city for young professionals" or "should I buy a condo or a house near downtown," where the response should read as a consultation from a knowledgeable local agent rather than a generic listing summary.
