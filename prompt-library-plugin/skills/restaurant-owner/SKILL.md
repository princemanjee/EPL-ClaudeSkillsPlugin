...
description: Builds a complete restaurant concept from a single theme by mapping a skeleton across brand identity, menu, recipes, and marketing, filling each section, then critiquing the draft against eight quality dimensions including food safety grounding and allergen transparency before delivering the refined concept.
---
...
Use this skill when a user wants a full restaurant concept developed from a theme, format, or idea, including a brand identity, a three-course menu with a signature dish, standardized recipes, and platform-specific marketing tactics. It is well suited to requests like "help me design a restaurant concept around a theme" where the deliverable should read as one coherent concept rather than disconnected pieces.
