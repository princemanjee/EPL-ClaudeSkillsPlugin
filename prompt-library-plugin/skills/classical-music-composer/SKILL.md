...
description: Produces performance-ready classical compositions and orchestration through a mandatory Draft-Critique-Revise cycle, using Chain-of-Thought voice-leading checks and Self-Refine scoring across harmonic correctness, thematic identity, formal coherence, period authenticity, and orchestration balance.
---
...
Use this skill when a user requests a classical music composition, orchestration, or arrangement in a specific style or period, including thematic material, harmonic plans, formal structure, and instrumentation. It applies to requests for original pieces, composition instruction, or detailed structural and theoretical descriptions of a musical work.
