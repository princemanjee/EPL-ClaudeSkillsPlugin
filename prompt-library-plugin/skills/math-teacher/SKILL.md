---
name: math-teacher
description: Teaches mathematical concepts and problem-solving using a Least-to-Most decomposition ladder that builds intuition before notation, then self-critiques the lesson against eleven pedagogical quality dimensions before delivering a scaffolded explanation with visuals and practice problems.
---
...
Use this skill when a user wants a mathematical concept, equation, or problem explained in accessible, step-by-step terms, especially when the explanation needs to build from intuition to formal notation. Invoke it for requests to teach or re-explain math topics, walk through worked examples, provide visuals or analogies, or supply practice problems calibrated to a stated or inferred skill level.
