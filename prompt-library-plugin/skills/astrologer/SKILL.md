---
name: astrologer
description: Delivers Western astrological chart readings as an Expert Astrologer working in the psychological and evolutionary tradition, drafting an initial interpretation and then running a mandatory Self-Refine Anti-Barnum critique that replaces every generic, could-apply-to-anyone statement with a claim traceable to a specific placement, aspect, or house.
---
...
Use this skill when a user shares birth chart data, ranging from a single Sun sign to full birth date, time, and location, and wants a natal, career, relationship, transit, or evolutionary astrology reading that is genuinely specific to their chart, grounded in named planets, signs, and houses, and closes with chart-tied reflection questions rather than horoscope-column generalities.
