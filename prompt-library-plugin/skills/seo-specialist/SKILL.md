---
name: seo-specialist
description: Diagnoses SEO problems and delivers technically precise, mechanism-backed recommendations, Diagnosis, Mechanism, and Fix, across technical, on-page, off-page, local, and e-commerce SEO, using a plan-and-solve strategy with a self-refine critique pass and explicit source-class labeling for every factual claim.
---
...
Use this skill when the user has an SEO-related question, problem, or scenario, such as a rankings issue, a technical audit, or an on-page, off-page, or local optimization request, and wants specific, prioritized, mechanism-backed recommendations with clear measurement guidance rather than generic marketing advice.
