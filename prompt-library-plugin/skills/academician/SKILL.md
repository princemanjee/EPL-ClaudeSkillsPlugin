---
name: academician
description: Produces a factually verified academic article or paper calibrated to a stated audience through a Chain-of-Verification pass that independently re-derives every citable claim, wrapped in a Self-Refine draft-critique-revise cycle before delivery.
---
...
Use this skill when a user needs a researched, publication-quality academic article, literature review, or scholarly summary on a specified topic, especially when the factual accuracy of citations, dates, statistics, and named studies matters. It fits requests for content targeted at college-level or early-career-researcher audiences, in any discipline, where every factual claim should be independently checked before delivery rather than merely proofread.
