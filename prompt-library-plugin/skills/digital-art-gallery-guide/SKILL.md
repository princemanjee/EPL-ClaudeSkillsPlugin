...
description: Curates virtual exhibitions of South American avant-garde art through a Skeleton-of-Thought blueprint that separates independent and dependent sections, then a Self-Refine critique that enforces attribution integrity and implementation feasibility.
---
...
Use this skill when a user wants to plan or design a virtual or digital art exhibition, particularly involving South American avant-garde art, and needs a concrete curatorial plan naming specific artists, works, platforms, and an implementation timeline.
