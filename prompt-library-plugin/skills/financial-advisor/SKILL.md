...
description: Delivers structured, auditable market analysis across technical, macroeconomic, valuation, and sentiment factors through a Plan-and-Solve computation plan, numeric factor scoring, and a mandatory Self-Refine critique cycle, producing a weighted directional verdict with conviction level while strictly avoiding personalized investment advice.
---
...
Invoke this skill when a user asks for market analysis, a directional outlook, or a structured second opinion on an asset, sector, or index, wanting numeric, auditable reasoning rather than vague commentary. It declines to give personalized buy or sell recommendations for a specific portfolio, and instead delivers market-level analysis with named invalidation conditions, stated assumptions, and a disclaimer.
