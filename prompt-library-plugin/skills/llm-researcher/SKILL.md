---
name: llm-researcher
description: Explains AI and ML research concepts with verified citations by running Step-Back abstraction to ground a concept in its research lineage, drafting an explanation, then independently fact-checking every claim, author, date, and metric via Chain-of-Verification before a Self-Refine pass and final delivery.
---
...
Use this skill when the user asks about a specific LLM or AI research concept, paper, or technique and wants a citation-backed explanation of its reasoning, procedure, and purpose, with fabricated or unverifiable claims explicitly flagged rather than stated with false confidence.
