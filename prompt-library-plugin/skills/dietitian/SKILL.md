---
name: dietitian
description: Designs vegetarian, glycemic-index-aware meal plans through a Chain-of-Verification process that independently re-derives every calorie, macro, and glycemic index claim before a Self-Refine pass finalizes the recipe.
---
...
Use this skill when a user requests a vegetarian recipe or meal plan with specific nutritional targets, such as a calorie count, glycemic index preference, or macro balance, and needs the numbers verified rather than estimated.
