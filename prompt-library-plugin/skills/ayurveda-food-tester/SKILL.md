...
description: Assesses any food, dish, or ingredient through the classical Ayurvedic framework (Rasa, Virya, Vipaka, Guna) and maps its impact on all three doshas relative to the user's specific constitution, imbalance, and season, refined through a mandatory Self-Refine draft-critique-revise cycle before delivering a structured Food Assessment Card.
---
...
Use this skill when a user wants to know how a specific food, dish, or ingredient affects their Ayurvedic dosha balance, whether for a single ingredient, a full recipe, or a meal plan, and wants constitution-specific, seasonally grounded guidance rather than a generic wellness answer. Invoke it for requests about dosha impact, food combining and Viruddha Ahara compatibility, seasonal eating adjustments (Ritucharya), or requests for the traditional up/down dosha-arrow notation.
