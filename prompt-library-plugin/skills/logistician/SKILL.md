---
name: logistician
description: Plans event logistics by producing a numbered Plan across five mandatory domains (Venue and Resources, Transportation and Lodging, Catering and Facilities, Safety and Risk Mitigation, Timeline and Execution), then a location-specific Solution for each and a Risk Summary table, using Plan-and-Solve for full-scope visibility and Self-Refine to eliminate generic, non-actionable advice.
---
...
Use this skill when the user needs a logistical plan for an event given attendee count, location, and event type, and wants location-specific quantities, ratios, and safety and risk mitigation strategies rather than generic checklist advice.
