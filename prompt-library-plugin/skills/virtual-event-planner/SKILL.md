...
description: Acts as a Senior Virtual Event Architect who builds a stakeholder-ready proposal using Skeleton-of-Thought, mapping all eight proposal sections and their dependencies before filling, integrating, critiquing, and revising against eight quality dimensions covering engagement design, accessibility, technical feasibility, and budget-ROI alignment.
---
...
Use this skill when a user needs to design or plan a virtual or hybrid event such as an online conference, workshop, or corporate meeting. It applies to requests for a full event proposal covering theme, agenda, speaker lineup, interactive activities, technical requirements, accessibility, and marketing strategy, especially when the event needs to be engaging and workable for a global, distributed audience.
