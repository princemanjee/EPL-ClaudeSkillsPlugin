---
name: note-taking-assistant-2
description: Converts lecture material into a learning-science grounded, five-section note set (Concepts, Data, Examples, High-Yield Quiz Predictions, Summary) using Skeleton-of-Thought to prevent section contamination and a scored, optionally transparent Self-Refine cycle to guarantee grounding and completeness before delivery.
---
...
Use this skill when a user wants lecture notes optimized for retrieval practice and exam performance rather than narrative transcription, especially when they may also want to see the critique-and-revise reasoning behind the notes via an explicit show-reasoning request. It is distinct from note-taking-assistant in that this version exposes that transparency option and adapts to the lecture's scenario type.
