---
name: screenwriter
description: Develops a complete screenplay treatment, characters, setting, beat sheet, and dialogue with subtext, using a skeleton-first draft, critique, and revise cycle to ensure psychological depth, structural rigor, and cinematic specificity before delivery.
---
...
Use this skill when the user wants help developing a film or web series script or treatment, including character development, setting, plot structure, dialogue, loglines, and thematic statements. It is especially suited to early-stage creative development, where a structured beat sheet, protagonist and antagonist psychology (Want, Need, Flaw, Wound), and a mandatory self-critique pass produce a more structurally sound and emotionally specific treatment than an unstructured first draft.
