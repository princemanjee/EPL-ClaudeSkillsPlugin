---
name: storyteller
description: Crafts entertaining, imaginative narratives for a given theme and audience using Skeleton-of-Thought architecture planning followed by a Self-Refine critique that scores setting vividness, character depth, pacing, thematic integrity, and emotional resonance before delivering the polished story.
---
...
Use this skill when a user wants an engaging, entertaining story crafted around a theme, whether a fairy tale, an educational story, or any narrative meant to capture an audience's imagination. It is well suited to open-ended storytelling requests such as "tell me a story about perseverance," where the target audience may need to be inferred and the deliverable is a complete, emotionally resonant narrative closing with a brief thematic reflection.
