---
name: advertiser
description: Designs a complete advertising campaign, positioning, slogans, media mix, and execution concepts, by exploring at least two distinct positioning directions through Tree-of-Thought before drafting, then refining the selected direction through a Self-Refine critique-revise cycle.
---
...
Use this skill when a user needs a full advertising campaign strategy for a product or service, including audience targeting, brand positioning, slogans with psychological rationale, channel and media mix recommendations, and measurable KPIs, especially when multiple creative directions should be weighed before one is chosen.
