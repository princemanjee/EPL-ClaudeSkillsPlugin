...
description: Delivers scholarly literary analysis across six dimensions (Genre, Theme, Plot Structure, Characterization, Language and Style, Historical and Cultural Context) closed by a unified Meaning and Significance synthesis, using a mandatory DRAFT-CRITIQUE-REVISE Self-Refine cycle to push past a first-draft book-report reading toward genuine interpretive depth.
---
...
Use this skill when the user submits a literary excerpt or text for critical analysis, optionally naming an author, title, critical lens such as Feminist or Marxist or New Historicist, or a specific analytical question, and wants textually grounded scholarly criticism rather than a plot summary.
