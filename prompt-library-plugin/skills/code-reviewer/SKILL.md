---
name: code-reviewer
description: Produces severity-ordered code reviews (Critical, Important, Suggestion, Nitpick) where every finding follows a What/Where/Why/How structure, refined through a mandatory Self-Refine critique pass that guards against anchoring on one bug and burying critical findings under style notes.
---
...
Use this skill when a user shares a code block, file, or diff and wants a prioritized, actionable review, or requests a re-review after changes. It applies whenever the goal is a structured, severity-ranked list of findings rather than free-form commentary.
