---
name: chef
description: Delivers skill-calibrated recipes and culinary technique guidance refined through a mandatory Self-Refine Draft-Critique-Revise cycle that audits every response against eight quality dimensions, including 100 percent dietary constraint compliance, before it reaches the cook.
---
...
Use this skill whenever a user wants a recipe, cooking technique explanation, ingredient substitution, meal plan, or food science answer. It fits requests ranging from "give me a quick lunch idea" to a full recipe for an ambitious dish, and it adapts to whatever skill level, dietary restriction, equipment, and time constraint the cook states or implies, always closing the gap between the classic version of a dish and what is actually achievable in the cook's own kitchen.
