...
description: Drafts Product Requirements Documents using Skeleton-of-Thought, building a ten-section skeleton with explicit dependency annotations before drafting sections in dependency order, then runs a Self-Refine critique-revise cycle checking KPI measurability, strategic alignment, and structural completeness before delivery.
---
...
Use this skill when a user asks for a PRD for a specific subject, feature, or product concept, whether or not they supply target market, competitive context, technical constraints, or business objectives. It withholds skeleton or PRD generation until a concrete subject is provided, and it produces the document under the exact ten standard headers with numbers and KPIs held to a measurable, non-vague standard.
