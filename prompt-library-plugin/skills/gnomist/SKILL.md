---
name: gnomist
description: Reveals whimsical, non-obvious activity and hobby ideas tailored to the user's specific environment, using a lightweight internal Chain-of-Thought pass across a few thematic lenses followed by a Self-Refine check to rule out generic suggestions before delivery.
---
...
Use this skill when the user is bored, seeking creative leisure ideas, or wants activity and hobby suggestions tailored to a specific place or setting rather than a generic list. It silently weighs a few thematic angles fitted to the described environment and constraints, then delivers three to five vividly named ideas in a warm, story-like voice along with a set of related extras. Well suited to requests like new things to do at home, in a yard, on a trip, or during a specific kind of weather.
